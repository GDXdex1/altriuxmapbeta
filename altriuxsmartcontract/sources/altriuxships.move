module altriux::altriuxships {
    ...
    use altriux::altriuxbuildingbase::{Self, BuildingRegistry, BuildingNFT};
    ...
    // === RECURSOS (IDs de altriuxresources/manufactured) ===
    fun JAX_MADERA_DURA(): u64 { 153 } // Raw
    fun JAX_VIGA_LARGA(): u64 { altriuxmanufactured::VIGA_LARGA() }
    fun JAX_BREA_VEGETAL(): u64 { 209 } // Raw
    fun JAX_CLAVOS(): u64 { altriuxmanufactured::JAX_CLAVOS() }
    fun JAX_JARCIAS(): u64 { altriuxmanufactured::JAX_JARCIAS() }
    fun JAX_FOQUE(): u64 { altriuxmanufactured::JAX_FOQUE() }
    fun JAX_CONTRAFOQUE(): u64 { altriuxmanufactured::JAX_CONTRAFOQUE() }
    fun JAX_BAUPRES(): u64 { altriuxmanufactured::JAX_BAUPRES() }
    ...
    public fun start_ship_construction(
        ...
        assert!(has_jax(resource_inv, altriuxmanufactured::TABLON_ANCHO(), wood_required), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::JAX_CLAVOS(), nails_required), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::RESINA_MADERA(), tar_required), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::VIGA_LARGA(), beams_required), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::JAX_JARCIAS(), ropes_required), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::JAX_BAUPRES(), 1), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::JAX_FOQUE(), 1), E_INSUFFICIENT_RESOURCES);
        assert!(has_jax(resource_inv, altriuxmanufactured::JAX_CONTRAFOQUE(), 1), E_INSUFFICIENT_RESOURCES);
        
        // Consumir recursos
        consume_jax(resource_inv, altriuxmanufactured::TABLON_ANCHO(), wood_required, clock);
        consume_jax(resource_inv, altriuxmanufactured::JAX_CLAVOS(), nails_required, clock);
        consume_jax(resource_inv, altriuxmanufactured::RESINA_MADERA(), tar_required, clock);
        consume_jax(resource_inv, altriuxmanufactured::VIGA_LARGA(), beams_required, clock);
        consume_jax(resource_inv, altriuxmanufactured::JAX_JARCIAS(), ropes_required, clock);
        consume_jax(resource_inv, altriuxmanufactured::JAX_BAUPRES(), 1, clock);
        consume_jax(resource_inv, altriuxmanufactured::JAX_FOQUE(), 1, clock);
        consume_jax(resource_inv, altriuxmanufactured::JAX_CONTRAFOQUE(), 1, clock);
