module altriux::altriuxmovement {
    ...
    public fun initiate_travel(
        ...
        altriuxhero::start_hero_travel(hero, status);
    }
    ...
    public fun complete_travel(
        ...
        // Update Position
        altriuxhero::update_hero_position(hero, dest_tile);
        altriuxhero::update_hero_coords(hero, t_hq, t_hr, t_hq_n, t_hr_n, t_sq, t_sr, t_sq_n, t_sr_n);
        
        // Clear Status
        altriuxhero::clear_travel_status(hero);
    }
    ...
    public fun cancel_travel(
        ...
        altriuxhero::update_hero_position(hero, 0); // Reset tile ID
        altriuxhero::update_hero_coords(hero, i_hq, i_hr, i_hqn, i_hrn, i_sq, i_sr, i_sqn, i_srn);
