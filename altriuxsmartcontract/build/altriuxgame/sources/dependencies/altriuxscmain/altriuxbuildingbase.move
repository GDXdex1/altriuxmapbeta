module altriux::altriuxbuildingbase {
    ...
    const FORJA: u64 = 15;
    const TALLER_ARMAS: u64 = 16;
    const TALLER_HERRAMIENTAS: u64 = 17;
    const HORNOS_CAL: u64 = 18;
    const ALFARERIA: u64 = 19;
    const VIDRERIA: u64 = 20;
    ...
    const MOLINO_LEGUMBRES: u64 = 48; // Moved to avoid collision with military/docks

    const MURALLA_MADERA: u64 = 44;
    const MURALLA_PIEDRA: u64 = 45;
    const TORRE_VIGIA: u64 = 46;
    const FOSO: u64 = 47;
    const GRANJA_ANIMALES: u64 = 48;
    const PESQUERIA: u64 = 49;
    const TALLER_MADERA: u64 = 50;
    const TALLER_PIEDRA: u64 = 51;
    const FABRICA_ARMAS_ASEDIO: u64 = 53;
