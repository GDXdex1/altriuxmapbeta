module altriux::altriuxbooks {
    ...
    public fun transcribe_book(
        ...
        altriuxresources::consume_jax(inv, altriuxresources::id_papel(), paper_req, clock);
        altriuxresources::consume_jax(inv, altriuxresources::id_tinta(), ink_req, clock);
        altriuxresources::consume_jax(inv, altriuxresources::id_pluma(), 1, clock);
