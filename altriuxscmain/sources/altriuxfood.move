module altriux::altriuxfood {
    ...
    public fun JAX_EGG(): u64 { 202 }
    public fun JAX_SALT(): u64 { 203 }
    ...
    public fun get_category(food_id: u64): u8 {
        ...
        else if (food_id == 201 || food_id == 202) CAT_EGG_DAIRY
        else if (food_id == 203) CAT_MINERAL
